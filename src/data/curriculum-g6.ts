...
export const G6_QUESTIONS: SeedQuestion[] = [
  ...
  // --- 서술형 (Word Problems) ---
  {
    id: 'G6_S1_NUM_01_SK03_WP01',
    skillId: 'G6_S1_NUM_01_SK03',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '밀가루 3/4kg을 쿠키 6판에 똑같이 나누어 넣으려고 합니다. 쿠키 한 판에 필요한 밀가루는 몇 kg인가요?',
      correctAnswer: '1/8',
      explanation: '3/4 ÷ 6 = 3/(4×6) = 3/24 = 1/8 kg입니다.',
      hints: ['3/4를 6으로 나누세요.', '분수를 자연수로 나눌 때는 분모에 자연수를 곱해요.'],
      commonMistakes: [{ answer: '18/4', misconception: '분자에 6을 곱했어요. 나누려면 분모에 곱하세요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['word_problem', '분수', '나눗셈', '요리', '6학년'],
  },
  {
    id: 'G6_S1_NUM_01_SK02_WP01',
    skillId: 'G6_S1_NUM_01_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '주스 4/5L를 한 컵에 2/5L씩 담으면 몇 컵을 만들 수 있나요?',
      correctAnswer: '2',
      explanation: '4/5 ÷ 2/5 = 4/5 × 5/2 = 20/10 = 2컵입니다.',
      hints: ['4/5를 2/5로 나누세요.', '나누는 분수의 역수를 곱하세요. 2/5의 역수는 5/2'],
      commonMistakes: [{ answer: '2/5', misconception: '분자끼리 나누고 분모끼리 나눠서 2/5로 답했어요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['word_problem', '분수', '나눗셈', '음료', '6학년'],
  },
  {
    id: 'G6_S1_NUM_03_SK01_WP01',
    skillId: 'G6_S1_NUM_03_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '리본 7.2m를 4명에게 똑같이 나누어 주려고 합니다. 한 사람에게 몇 m씩 줄 수 있나요?',
      correctAnswer: '1.8',
      explanation: '7.2 ÷ 4 = 1.8m입니다.',
      hints: ['7.2를 4로 나누세요.', '72 ÷ 4 = 18, 소수점을 찍으면 1.8'],
      commonMistakes: [{ answer: '1.2', misconception: '7.2 ÷ 4를 잘못 계산했어요. 72 ÷ 4 = 18입니다.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', '소수', '나눗셈', '6학년'],
  },
  {
    id: 'G6_S1_NUM_03_SK02_WP01',
    skillId: 'G6_S1_NUM_03_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '자동차가 2.5시간에 162.5km를 갔습니다. 이 자동차의 시속은 몇 km인가요?',
      correctAnswer: '65',
      explanation: '162.5 ÷ 2.5 = 65 km/h입니다. 나누는 수를 자연수로 만들면: 1625 ÷ 25 = 65',
      hints: ['거리 ÷ 시간 = 속도예요.', '162.5 ÷ 2.5에서 둘 다 10을 곱하면 1625 ÷ 25'],
      commonMistakes: [{ answer: '6.5', misconception: '소수점을 잘못 찍었어요. 1625 ÷ 25 = 65입니다.' }],
    },
    estimatedTimeSeconds: 40,
    tags: ['word_problem', '소수', '나눗셈', '속도', '여행', '6학년'],
  },
  {
    id: 'G6_S1_CHANGE_04_SK01_WP01',
    skillId: 'G6_S1_CHANGE_04_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 0.7,
    difficultyLabel: '보통',
    content: {
      questionText: '농구 동아리에 남학생 12명, 여학생 8명이 있습니다. 남학생과 여학생의 비를 가장 간단한 자연수의 비로 나타내세요.',
      correctAnswer: '3:2',
      explanation: '12:8의 최대공약수는 4입니다. 12÷4 : 8÷4 = 3:2',
      hints: ['12와 8의 최대공약수를 구하세요.', '12÷4=3, 8÷4=2'],
      commonMistakes: [{ answer: '12:8', misconception: '약분하지 않았어요. 가장 간단한 비로 만들어야 해요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', '비', '스포츠', '6학년'],
  },
  {
    id: 'G6_S1_CHANGE_04_SK02_WP01',
    skillId: 'G6_S1_CHANGE_04_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '마트에서 원래 가격 8000원인 과자를 25% 할인하고 있습니다. 할인된 가격은 얼마인가요?',
      correctAnswer: '6000',
      explanation: '할인 금액: 8000 × 25/100 = 2000원. 할인된 가격: 8000 - 2000 = 6000원입니다.',
      hints: ['25%는 전체의 1/4이에요.', '8000 × 1/4 = 2000원을 빼세요.'],
      commonMistakes: [{ answer: '2000', misconception: '할인 금액만 구했어요. 원래 가격에서 빼야 합니다.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', '백분율', '할인', '쇼핑', '6학년'],
  },
  {
    id: 'G6_S1_DATA_05_SK01_WP01',
    skillId: 'G6_S1_DATA_05_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 0.8,
    difficultyLabel: '보통',
    content: {
      questionText: '학급 40명 중 좋아하는 과목 조사에서 수학이 30%였습니다. 수학을 좋아하는 학생은 몇 명인가요?',
      correctAnswer: '12',
      explanation: '40 × 30/100 = 40 × 0.3 = 12명입니다.',
      hints: ['30%는 30/100 = 0.3이에요.', '40 × 0.3을 계산하세요.'],
      commonMistakes: [{ answer: '3', misconception: '30%를 3명으로 착각했어요. 40명의 30%를 계산해야 해요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', '백분율', '통계', '그래프', '6학년'],
  },
  {
    id: 'G6_S2_CHANGE_03_SK01_WP01',
    skillId: 'G6_S2_CHANGE_03_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.3,
    difficultyLabel: '어려움',
    content: {
      questionText: '3:5 = 12:x 일 때 x의 값은 얼마인가요?',
      correctAnswer: '20',
      explanation: '비례식의 성질: 외항의 곱 = 내항의 곱. 3 × x = 5 × 12, 3x = 60, x = 20입니다.',
      hints: ['외항의 곱 = 내항의 곱을 이용하세요.', '3 × x = 5 × 12'],
      commonMistakes: [{ answer: '4', misconception: '12 ÷ 3 = 4로만 계산했어요. 비례식의 성질을 사용하세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', '비례식', '6학년'],
  },
  {
    id: 'G6_S2_CHANGE_03_SK02_WP01',
    skillId: 'G6_S2_CHANGE_03_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '용돈 15000원을 형과 동생이 3:2로 나누어 가지려고 합니다. 형이 받는 금액은 얼마인가요?',
      correctAnswer: '9000',
      explanation: '비의 합 = 3+2 = 5. 형의 몫: 15000 × 3/5 = 9000원입니다.',
      hints: ['비의 합을 먼저 구하세요: 3+2=5', '형: 15000 × 3/5 = ?'],
      commonMistakes: [{ answer: '7500', misconception: '반으로 나누었어요. 3:2 비율로 나누어야 합니다.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['word_problem', '비례배분', '6학년'],
  },
  {
    id: 'G6_S2_SHAPE_04_SK02_WP01',
    skillId: 'G6_S2_SHAPE_04_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.3,
    difficultyLabel: '어려움',
    content: {
      questionText: '원 모양의 화단의 반지름이 5m입니다. 이 화단의 넓이는 약 몇 m²인가요? (원주율 = 3.14)',
      correctAnswer: '78.5',
      explanation: '원의 넓이 = π × r² = 3.14 × 5 × 5 = 3.14 × 25 = 78.5 m²입니다.',
      hints: ['원의 넓이 = 반지름 × 반지름 × 원주율이에요.', '5 × 5 = 25, 25 × 3.14 = ?'],
      commonMistakes: [{ answer: '31.4', misconception: '원주(둘레)를 구했어요. 넓이는 π × r²입니다.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['word_problem', '원', '넓이', '건축', '6학년'],
  },
  {
    id: 'G6_S2_SHAPE_04_SK01_WP01',
    skillId: 'G6_S2_SHAPE_04_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '자전거 바퀴의 지름이 70cm입니다. 이 바퀴가 한 바퀴 굴러가면 약 몇 cm를 이동하나요? (원주율 = 3.14)',
      correctAnswer: '219.8',
      explanation: '원주 = 지름 × 원주율 = 70 × 3.14 = 219.8cm입니다.',
      hints: ['한 바퀴 = 원주(둘레)예요.', '원주 = 지름 × π = 70 × 3.14'],
      commonMistakes: [{ answer: '109.9', misconception: '반지름으로 계산했어요. 지름 = 70cm를 그대로 사용하세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', '원주', '여행', '6학년'],
  },
  {
    id: 'G6_S2_NUM_01_SK01_WP01',
    skillId: 'G6_S2_NUM_01_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.6,
    difficultyLabel: '어려움',
    content: {
      questionText: '설탕 2와 1/3컵을 레시피의 1과 2/3배만큼 사용하면 설탕이 얼마나 필요한가요? (대분수로 답하세요)',
      correctAnswer: '3과 8/9',
      explanation: '2와 1/3 = 7/3, 1과 2/3 = 5/3. 7/3 × 5/3 = 35/9 = 3과 8/9입니다.',
      hints: ['대분수를 가분수로 바꾸세요.', '7/3 × 5/3 = 35/9, 이것을 대분수로 바꾸세요.'],
      commonMistakes: [{ answer: '2와 2/9', misconception: '정수는 정수끼리, 분수는 분수끼리 곱했어요.' }],
    },
    estimatedTimeSeconds: 45,
    tags: ['word_problem', '분수', '나눗셈', '요리', '6학년'],
  },
  {
    id: 'G6_S2_NUM_02_SK01_WP01',
    skillId: 'G6_S2_NUM_02_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.4,
    difficultyLabel: '어려움',
    content: {
      questionText: '철사 8.4m를 0.6m씩 자르면 몇 도막이 되나요?',
      correctAnswer: '14',
      explanation: '8.4 ÷ 0.6 = 14도막입니다. 84 ÷ 6 = 14',
      hints: ['8.4 ÷ 0.6에서 둘 다 10을 곱하세요.', '84 ÷ 6 = ?'],
      commonMistakes: [{ answer: '1.4', misconception: '소수점을 잘못 찍었어요. 84 ÷ 6 = 14입니다.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', '소수', '나눗셈', '6학년'],
  },
  {
    id: 'G6_S1_CHANGE_04_SK02_WP02',
    skillId: 'G6_S1_CHANGE_04_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '야구 선수가 20번 타석에서 7번 안타를 쳤습니다. 이 선수의 타율을 백분율로 나타내면 몇 %인가요?',
      correctAnswer: '35',
      explanation: '타율 = 안타 수 ÷ 타석 수 = 7/20 = 0.35 = 35%입니다.',
      hints: ['7 ÷ 20을 계산하세요.', '0.35 × 100 = 35%'],
      commonMistakes: [{ answer: '70', misconception: '7/10으로 계산했어요. 타석이 20번이에요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', '비율', '백분율', '스포츠', '6학년'],
  },
  {
    id: 'G6_S2_CHANGE_03_SK02_WP02',
    skillId: 'G6_S2_CHANGE_03_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '설탕물 200g을 만드는데 설탕과 물을 1:9로 섞었습니다. 설탕은 몇 g 넣었나요?',
      correctAnswer: '20',
      explanation: '비의 합 = 1+9 = 10. 설탕 = 200 × 1/10 = 20g입니다.',
      hints: ['비의 합을 먼저 구하세요: 1+9=10', '설탕: 200 × 1/10 = ?'],
      commonMistakes: [{ answer: '100', misconception: '200을 2로 나누었어요. 1:9 비율로 나누어야 합니다.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', '비례배분', '농도', '요리', '6학년'],
  },
  {
    id: 'G6_S1_SHAPE_02_SK01_WP01',
    skillId: 'G6_S1_SHAPE_02_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 0.8,
    difficultyLabel: '보통',
    content: {
      questionText: '오각기둥의 면, 꼭짓점, 모서리의 수를 각각 구하세요. (면, 꼭짓점, 모서리 순으로 쓰세요)',
      correctAnswer: '7, 10, 15',
      explanation: 'n각기둥: 면 n+2개, 꼭짓점 2n개, 모서리 3n개. 오각기둥: 면 7개, 꼭짓점 10개, 모서리 15개.',
      hints: ['밑면 2개 + 옆면 5개 = 총 7개의 면', '꼭짓점: 위 5개 + 아래 5개 = 10개'],
      commonMistakes: [{ answer: '5, 10, 15', misconception: '밑면 2개를 빼먹었어요. 면은 밑면 2 + 옆면 5 = 7개입니다.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['word_problem', '각기둥', '6학년'],
  },
  {
    id: 'G6_S2_DATA_06_SK01_WP01',
    skillId: 'G6_S2_DATA_06_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '주머니에 빨간 구슬 3개, 파란 구슬 5개, 노란 구슬 2개가 들어 있습니다. 눈을 감고 하나를 꺼낼 때, 파란 구슬이 나올 가능성을 분수로 나타내면?',
      correctAnswer: '1/2',
      explanation: '전체 구슬 = 3+5+2 = 10개. 파란 구슬 = 5개. 가능성 = 5/10 = 1/2',
      hints: ['전체 구슬 수를 세세요.', '파란 구슬 수 ÷ 전체 구슬 수 = ?'],
      commonMistakes: [{ answer: '5/10', misconception: '정답이지만 약분하면 1/2예요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', '가능성', '확률', '6학년'],
  },
  {
    id: 'G6_S1_NUM_03_SK02_WP02',
    skillId: 'G6_S1_NUM_03_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.8,
    difficultyLabel: '매우 어려움',
    content: {
      questionText: '물 1L에 소금 0.15kg을 녹여 소금물을 만들었습니다. 이 소금물 0.5L에 들어 있는 소금은 몇 kg인가요?',
      correctAnswer: '0.075',
      explanation: '1L에 0.15kg이므로 0.5L에는 0.15 × 0.5 = 0.075kg입니다.',
      hints: ['소금의 양도 절반이 돼요.', '0.15 × 0.5를 계산하세요. 15 × 5 = 75, 소수점 세 자리'],
      commonMistakes: [{ answer: '0.3', misconception: '0.15 ÷ 0.5로 계산했어요. 곱해야 합니다.' }],
    },
    estimatedTimeSeconds: 40,
    tags: ['word_problem', '소수', '곱셈', '농도', '6학년'],
  },
  {
    id: 'G6_S2_CHANGE_03_SK01_WP02',
    skillId: 'G6_S2_CHANGE_03_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '지도에서 2cm가 실제 거리 500m입니다. 지도에서 7cm인 두 지점의 실제 거리는 몇 m인가요?',
      correctAnswer: '1750',
      explanation: '2:500 = 7:x. 외항의 곱 = 내항의 곱: 2x = 500×7 = 3500, x = 1750m입니다.',
      hints: ['비례식을 세우세요: 2:500 = 7:x', '2 × x = 500 × 7'],
      commonMistakes: [{ answer: '3500', misconception: '500 × 7 = 3500으로만 계산하고 2로 나누는 것을 빠뜨렸어요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['word_problem', '비례식', '지도', '여행', '6학년'],
  },

  {
    id: 'G6_S2_SHAPE_05_SK01_WP01',
    skillId: 'G6_S2_SHAPE_05_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: 1.1,
    difficultyLabel: '어려움',
    content: {
      questionText: '음료수 캔이 원기둥 모양입니다. 밑면의 반지름이 3cm이고 높이가 12cm일 때, 옆면을 펼치면 직사각형이 됩니다. 이 직사각형의 가로 길이는 약 몇 cm인가요? (원주율 = 3.14)',
      correctAnswer: '18.84',
      explanation: '옆면의 가로 = 밑면의 원주 = 2 × π × r = 2 × 3.14 × 3 = 18.84cm입니다.',
      hints: ['원기둥의 옆면을 펼치면 가로 = 원주예요.', '원주 = 지름 × π = 6 × 3.14'],
      commonMistakes: [{ answer: '12', misconception: '높이를 가로로 착각했어요. 가로는 밑면의 원주입니다.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['word_problem', '원기둥', '전개도', '6학년'],
  },

  // --- ORDERING 문제 ---
  {
    id: 'G6_S1_NUM_01_SK01_ORD01',
    skillId: 'G6_S1_NUM_01_SK01',
    questionType: 'ORDERING',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '다음 분수의 나눗셈 결과를 큰 것부터 순서대로 놓으세요.',
      correctOrder: ['3/4 ÷ 1 = 3/4', '1/2 ÷ 1 = 1/2', '2/3 ÷ 2 = 1/3', '1/4 ÷ 2 = 1/8'],
      explanation: '3/4 > 1/2 > 1/3 > 1/8 순서입니다.',
      hints: ['각 나눗셈을 먼저 계산하세요.', '분수의 크기를 비교하세요.'],
      commonMistakes: [{ answer: '1/4÷2,2/3÷2,1/2÷1,3/4÷1', misconception: '작은 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 40,
    tags: ['ordering', '분수', '나눗셈', '6학년'],
  },
  {
    id: 'G6_S1_NUM_03_SK01_ORD01',
    skillId: 'G6_S1_NUM_03_SK01',
    questionType: 'ORDERING',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '다음 소수의 나눗셈 결과를 작은 것부터 순서대로 놓으세요.',
      correctOrder: ['2.4 ÷ 8 = 0.3', '4.5 ÷ 5 = 0.9', '7.2 ÷ 4 = 1.8', '9.6 ÷ 3 = 3.2'],
      explanation: '0.3 < 0.9 < 1.8 < 3.2 순서입니다.',
      hints: ['각 나눗셈을 먼저 계산하세요.', '24÷8=3 → 0.3, 45÷5=9 → 0.9, ...'],
      commonMistakes: [{ answer: '9.6÷3,7.2÷4,4.5÷5,2.4÷8', misconception: '큰 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['ordering', '소수', '나눗셈', '6학년'],
  },
  {
    id: 'G6_S1_CHANGE_04_SK02_ORD01',
    skillId: 'G6_S1_CHANGE_04_SK02',
    questionType: 'ORDERING',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '다음 백분율을 큰 것부터 순서대로 놓으세요.',
      correctOrder: ['3/4 = 75%', '2/3 ≈ 66.7%', '1/2 = 50%', '1/5 = 20%'],
      explanation: '75% > 66.7% > 50% > 20% 순서입니다.',
      hints: ['각 분수를 백분율로 바꾸세요.', '분자 ÷ 분모 × 100으로 계산하세요.'],
      commonMistakes: [{ answer: '1/5,1/2,2/3,3/4', misconception: '작은 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 40,
    tags: ['ordering', '비율', '백분율', '6학년'],
  },
  {
    id: 'G6_S2_CHANGE_03_SK01_ORD01',
    skillId: 'G6_S2_CHANGE_03_SK01',
    questionType: 'ORDERING',
    difficulty: 1.3,
    difficultyLabel: '어려움',
    content: {
      questionText: '다음 비례식에서 x의 값을 구하고, x가 작은 것부터 순서대로 놓으세요.',
      correctOrder: ['2:3 = 4:x → x=6', '3:4 = 6:x → x=8', '1:5 = 3:x → x=15', '2:7 = 6:x → x=21'],
      explanation: 'x=6, 8, 15, 21 순서입니다.',
      hints: ['외항의 곱 = 내항의 곱을 이용하세요.', '2×x = 3×4에서 x=6'],
      commonMistakes: [{ answer: '2:7=6:x,1:5=3:x,3:4=6:x,2:3=4:x', misconception: '큰 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 50,
    tags: ['ordering', '비례식', '6학년'],
  },
  {
    id: 'G6_S2_SHAPE_04_SK02_ORD01',
    skillId: 'G6_S2_SHAPE_04_SK02',
    questionType: 'ORDERING',
    difficulty: 1.3,
    difficultyLabel: '어려움',
    content: {
      questionText: '다음 원의 넓이를 작은 것부터 순서대로 놓으세요. (π = 3.14)',
      correctOrder: ['반지름 2cm → 12.56cm²', '반지름 3cm → 28.26cm²', '반지름 5cm → 78.5cm²', '반지름 7cm → 153.86cm²'],
      explanation: '반지름이 클수록 넓이도 커집니다. π×4=12.56, π×9=28.26, π×25=78.5, π×49=153.86',
      hints: ['원의 넓이 = π × r²이에요.', '반지름이 크면 넓이도 커요.'],
      commonMistakes: [{ answer: '반지름 7cm,5cm,3cm,2cm', misconception: '큰 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 45,
    tags: ['ordering', '원', '넓이', '6학년'],
  },
  {
    id: 'G6_S1_SHAPE_02_SK01_ORD01',
    skillId: 'G6_S1_SHAPE_02_SK01',
    questionType: 'ORDERING',
    difficulty: 0.8,
    difficultyLabel: '보통',
    content: {
      questionText: '다음 각기둥을 면의 수가 적은 것부터 순서대로 놓으세요.',
      correctOrder: ['삼각기둥 (5개)', '사각기둥 (6개)', '오각기둥 (7개)', '육각기둥 (8개)'],
      explanation: 'n각기둥의 면의 수 = n+2. 삼각(5), 사각(6), 오각(7), 육각(8)개입니다.',
      hints: ['각기둥의 면 = 밑면 2개 + 옆면 n개', 'n각기둥의 면 = n+2'],
      commonMistakes: [{ answer: '육각,오각,사각,삼각', misconception: '많은 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['ordering', '각기둥', '6학년'],
  },
  {
    id: 'G6_S1_NUM_01_SK02_ORD01',
    skillId: 'G6_S1_NUM_01_SK02',
    questionType: 'ORDERING',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '다음 분수 나눗셈의 결과를 작은 것부터 순서대로 놓으세요.',
      correctOrder: ['1/3 ÷ 2/3 = 1/2', '2/3 ÷ 1/2 = 4/3', '3/4 ÷ 1/3 = 9/4', '5/6 ÷ 1/4 = 10/3'],
      explanation: '1/2 < 4/3 < 9/4 < 10/3. 통분: 6/12, 16/12, 27/12, 40/12',
      hints: ['각 나눗셈을 계산하세요 (역수를 곱하세요).', '결과를 통분해서 비교하세요.'],
      commonMistakes: [{ answer: '5/6÷1/4,3/4÷1/3,2/3÷1/2,1/3÷2/3', misconception: '큰 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 50,
    tags: ['ordering', '분수', '나눗셈', '6학년'],
  },
  {
    id: 'G6_S2_DATA_06_SK01_ORD01',
    skillId: 'G6_S2_DATA_06_SK01',
    questionType: 'ORDERING',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '다음 사건의 가능성을 낮은 것부터 순서대로 놓으세요.',
      correctOrder: ['해가 서쪽에서 뜸 (0)', '주사위 6 나옴 (1/6)', '동전 앞면 (1/2)', '내일 해가 뜸 (1)'],
      explanation: '불가능(0) < 1/6 < 1/2 < 확실(1) 순서입니다.',
      hints: ['불가능한 사건의 가능성은 0이에요.', '확실한 사건의 가능성은 1이에요.'],
      commonMistakes: [{ answer: '내일 해가 뜸,동전 앞면,...', misconception: '높은 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['ordering', '가능성', '확률', '6학년'],
  },
  {
    id: 'G6_S2_CHANGE_03_SK02_ORD01',
    skillId: 'G6_S2_CHANGE_03_SK02',
    questionType: 'ORDERING',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '전체 120개를 다음 비로 나눌 때, 큰 쪽의 수가 많은 것부터 순서대로 놓으세요.',
      correctOrder: ['1:5 → 큰쪽 100개', '1:3 → 큰쪽 90개', '2:3 → 큰쪽 72개', '3:5 → 큰쪽 75개'],
      explanation: '1:5→100, 1:3→90, 3:5→75, 2:3→72. 정렬: 100>90>75>72',
      hints: ['비례배분 공식: 전체 × (비 / 비의 합)', '1:5일 때 큰 쪽 = 120 × 5/6 = 100'],
      commonMistakes: [{ answer: '2:3,3:5,1:3,1:5', misconception: '작은 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 50,
    tags: ['ordering', '비례배분', '6학년'],
  },
  {
    id: 'G6_S2_SHAPE_04_SK01_ORD01',
    skillId: 'G6_S2_SHAPE_04_SK01',
    questionType: 'ORDERING',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '다음 원의 원주(둘레)를 작은 것부터 순서대로 놓으세요. (π = 3.14)',
      correctOrder: ['지름 4cm → 12.56cm', '지름 6cm → 18.84cm', '지름 10cm → 31.4cm', '지름 14cm → 43.96cm'],
      explanation: '지름이 클수록 원주도 커집니다. 원주 = 지름 × π',
      hints: ['원주 = 지름 × 3.14예요.', '지름이 크면 둘레도 길어요.'],
      commonMistakes: [{ answer: '지름14,10,6,4', misconception: '큰 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['ordering', '원주', '6학년'],
  },

  // --- MATCHING 문제 ---
  {
    id: 'G6_S1_CHANGE_04_SK02_MAT01',
    skillId: 'G6_S1_CHANGE_04_SK02',
    questionType: 'MATCHING',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '비율과 백분율을 올바르게 연결하세요.',
      pairs: [
        { left: '1/4', right: '25%' },
        { left: '1/2', right: '50%' },
        { left: '3/4', right: '75%' },
      ...
      explanation: '1/4=0.25=25%, 1/2=0.5=50%, 3/4=0.75=75%, 1/5=0.2=20%입니다.',
      hints: ['분수를 소수로 바꾸면 백분율을 구하기 쉬워요.', '분자÷분모×100으로 계산하세요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '분수와 백분율의 변환을 잘못했어요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['matching', '비율', '백분율', '6학년'],
  },
  {
    id: 'G6_S1_NUM_01_SK01_MAT01',
    skillId: 'G6_S1_NUM_01_SK01',
    questionType: 'MATCHING',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '분수의 나눗셈과 그 결과를 올바르게 연결하세요.',
      pairs: [
        { left: '1/2 ÷ 3', right: '1/6' },
        { left: '3/4 ÷ 3', right: '1/4' },
        { left: '2/5 ÷ 2', right: '1/5' },
        { left: '5/6 ÷ 5', right: '1/6' },
      ],
      explanation: '분수÷자연수 = 분모에 자연수를 곱합니다. 1/2÷3=1/6, 3/4÷3=1/4, 2/5÷2=1/5, 5/6÷5=1/6',
      hints: ['분수를 자연수로 나눌 때는 분모에 곱하세요.', '1/2÷3 = 1/(2×3) = 1/6'],
      commonMistakes: [{ answer: 'mixed', misconception: '분자에 곱해서 잘못된 답을 연결했어요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['matching', '분수', '나눗셈', '6학년'],
  },
  {
    id: 'G6_S1_SHAPE_02_SK01_MAT01',
    skillId: 'G6_S1_SHAPE_02_SK01',
    questionType: 'MATCHING',
    difficulty: 0.8,
    difficultyLabel: '보통',
    content: {
      questionText: '입체도형과 밑면의 모양을 올바르게 연결하세요.',
      pairs: [
        { left: '삼각기둥', right: '삼각형' },
        { left: '사각기둥', right: '사각형' },
        { left: '삼각뿔', right: '삼각형' },
      ...
      explanation: '각기둥/각뿔의 이름은 밑면의 모양에서 옵니다. 원기둥의 밑면은 원입니다.',
      hints: ['기둥과 뿔의 이름은 밑면 모양에서 따와요.', '삼각기둥 → 밑면이 삼각형'],
      commonMistakes: [{ answer: 'mixed', misconception: '삼각뿔의 밑면이 사각형이라고 착각했어요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['matching', '각기둥', '각뿔', '6학년'],
  },
  {
    id: 'G6_S1_NUM_03_SK02_MAT01',
    skillId: 'G6_S1_NUM_03_SK02',
    questionType: 'MATCHING',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '소수의 나눗셈과 그 결과를 올바르게 연결하세요.',
      pairs: [
        { left: '3.6 ÷ 0.4', right: '9' },
        { left: '7.2 ÷ 0.8', right: '9' },
        { left: '4.5 ÷ 0.9', right: '5' },
        { left: '6.3 ÷ 0.7', right: '9' },
      ],
      explanation: '36÷4=9, 72÷8=9, 45÷9=5, 63÷7=9. 나누는 수를 자연수로 만들어 계산합니다.',
      hints: ['둘 다 10을 곱해서 자연수로 만드세요.', '3.6÷0.4 = 36÷4 = 9'],
      commonMistakes: [{ answer: 'mixed', misconception: '소수점을 잘못 옮겨서 결과가 달라졌어요.' }],
    },
    estimatedTimeSeconds: 40,
    tags: ['matching', '소수', '나눗셈', '6학년'],
  },
  {
    id: 'G6_S2_CHANGE_03_SK01_MAT01',
    skillId: 'G6_S2_CHANGE_03_SK01',
    questionType: 'MATCHING',
    difficulty: 1.3,
    difficultyLabel: '어려움',
    content: {
      questionText: '비례식과 x의 값을 올바르게 연결하세요.',
      pairs: [
        { left: '2:5 = x:15', right: 'x = 6' },
        { left: '3:x = 9:12', right: 'x = 4' },
        { left: 'x:8 = 3:4', right: 'x = 6' },
        { left: '7:x = 14:6', right: 'x = 3' },
      ],
      explanation: '외항의 곱 = 내항의 곱. 2×15=5x→x=6. 3×12=9x→x=4. 4x=24→x=6. 7×6=14x→x=3.',
      hints: ['외항의 곱 = 내항의 곱을 이용하세요.', 'a:b = c:d이면 a×d = b×c'],
      commonMistakes: [{ answer: 'mixed', misconception: '외항과 내항을 혼동했어요.' }],
    },
    estimatedTimeSeconds: 45,
    tags: ['matching', '비례식', '6학년'],
  },
  {
    id: 'G6_S2_SHAPE_04_SK01_MAT01',
    skillId: 'G6_S2_SHAPE_04_SK01',
    questionType: 'MATCHING',
    difficulty: 1.0,
    difficultyLabel: '보통',
    content: {
      questionText: '원과 관련된 용어와 공식을 올바르게 연결하세요.',
      pairs: [
        { left: '원주', right: '지름 × π' },
        { left: '원의 넓이', right: 'π × 반지름²' },
        { left: '지름', right: '반지름 × 2' },
        { left: '원주율(π)', right: '약 3.14' },
      ],
      explanation: '원주=지름×π, 넓이=π×r², 지름=2r, π≈3.14입니다.',
      hints: ['원주는 원의 둘레예요.', '원주율은 원주÷지름의 값이에요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '원주와 원의 넓이 공식을 혼동했어요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['matching', '원', '공식', '6학년'],
  },
  {
    id: 'G6_S1_CHANGE_04_SK01_MAT01',
    skillId: 'G6_S1_CHANGE_04_SK01',
    questionType: 'MATCHING',
    difficulty: 0.7,
    difficultyLabel: '보통',
    content: {
      questionText: '실생활 상황과 올바른 비를 연결하세요.',
      pairs: [
        { left: '남학생 15명, 여학생 10명', right: '3:2' },
        { left: '사과 6개, 배 4개', right: '3:2' },
        { left: '빨간색 2개, 파란색 5개', right: '2:5' },
        { left: '밀가루 3컵, 설탕 1컵', right: '3:1' },
      ],
      explanation: '15:10=3:2, 6:4=3:2, 2:5 그대로, 3:1 그대로입니다.',
      hints: ['각 비를 가장 간단한 자연수의 비로 나타내세요.', '최대공약수로 나누세요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '비를 약분하지 않아서 잘못 연결했어요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['matching', '비', '실생활', '6학년'],
  },
  {
    id: 'G6_S2_NUM_01_SK01_MAT01',
    skillId: 'G6_S2_NUM_01_SK01',
    questionType: 'MATCHING',
    difficulty: 1.6,
    difficultyLabel: '어려움',
    content: {
      questionText: '대분수 나눗셈과 그 결과를 올바르게 연결하세요.',
      pairs: [
        { left: '1과1/2 ÷ 1과1/2', right: '1' },
        { left: '2와1/3 ÷ 1과1/6', right: '2' },
        { left: '3과1/4 ÷ 1과5/8', right: '2' },
        { left: '1과1/3 ÷ 2/3', right: '2' },
      ],
      explanation: '3/2÷3/2=1, 7/3÷7/6=7/3×6/7=2, 13/4÷13/8=13/4×8/13=2, 4/3÷2/3=4/3×3/2=2',
      hints: ['대분수를 가분수로 바꾸세요.', '역수를 곱해서 계산하세요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '대분수를 가분수로 바꾸는 과정에서 실수했어요.' }],
    },
    estimatedTimeSeconds: 50,
    tags: ['matching', '분수', '나눗셈', '대분수', '6학년'],
  },
  {
    id: 'G6_S2_CHANGE_03_SK02_MAT01',
    skillId: 'G6_S2_CHANGE_03_SK02',
    questionType: 'MATCHING',
    difficulty: 1.5,
    difficultyLabel: '어려움',
    content: {
      questionText: '비례배분 상황과 결과를 올바르게 연결하세요.',
      pairs: [
        { left: '100을 2:3으로', right: '40과 60' },
        { left: '120을 1:3으로', right: '30과 90' },
        { left: '200을 3:7으로', right: '60과 140' },
        { left: '150을 2:1으로', right: '100과 50' },
      ],
      explanation: '100×2/5=40, 100×3/5=60. 120×1/4=30, 120×3/4=90. 200×3/10=60, 200×7/10=140. 150×2/3=100, 150×1/3=50.',
      hints: ['전체 × (각 비 / 비의 합)으로 계산하세요.', '비의 합을 먼저 구하세요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '비의 합을 잘못 구해서 결과가 틀렸어요.' }],
    },
    estimatedTimeSeconds: 45,
    tags: ['matching', '비례배분', '6학년'],
  },
  {
    id: 'G6_S1_DATA_05_SK01_MAT01',
    skillId: 'G6_S1_DATA_05_SK01',
    questionType: 'MATCHING',
    difficulty: 0.8,
    difficultyLabel: '보통',
    content: {
      questionText: '그래프의 종류와 가장 적합한 상황을 연결하세요.',
      pairs: [
        { left: '띠그래프', right: '전체에 대한 각 항목의 비율 비교' },
        { left: '원그래프', right: '전체를 100%로 하여 비율 표현' },
        { left: '막대그래프', right: '항목별 수량 비교' },
        { left: '꺾은선그래프', right: '시간에 따른 변화 표현' },
      ],
      explanation: '띠그래프/원그래프(비율), 막대그래프(수량 비교), 꺾은선그래프(시간 변화)입니다.',
      hints: ['비율을 나타내기 좋은 그래프는 띠그래프와 원그래프예요.', '시간 변화는 꺾은선그래프가 좋아요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '띠그래프와 막대그래프의 용도를 혼동했어요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['matching', '그래프', '통계', '6학년'],
  },
];
