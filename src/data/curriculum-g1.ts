...
export const G1_QUESTIONS: SeedQuestion[] = [
  ...
  // --- 덧셈과 뺄셈(1) 문장형 ---
  {
    id: 'G1_S1_NUM_03_SK02_WP01',
    skillId: 'G1_S1_NUM_03_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: -1.5,
    difficultyLabel: '쉬움',
    content: {
      questionText: '바구니에 사과가 3개 있었습니다. 엄마가 사과 4개를 더 사 왔습니다. 바구니에 사과는 모두 몇 개일까요?',
      correctAnswer: 7,
      explanation: '처음 3개에 4개를 더했으므로 3 + 4 = 7개입니다.',
      hints: ['처음에 있던 사과 수와 더 산 사과 수를 더하세요.', '3 + 4를 계산해 보세요.'],
      commonMistakes: [{ answer: '1', misconception: '뺄셈을 했어요. 더 사왔으니 더해야 합니다.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', 'addition', 'real_life', '1학년'],
  },
  {
    id: 'G1_S1_NUM_03_SK02_WP02',
    skillId: 'G1_S1_NUM_03_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: -1.5,
    difficultyLabel: '쉬움',
    content: {
      questionText: '연못에 개구리가 5마리 있었습니다. 2마리가 뛰어갔습니다. 남은 개구리는 몇 마리일까요?',
      correctAnswer: 3,
      explanation: '5마리에서 2마리가 떠났으므로 5 - 2 = 3마리입니다.',
      hints: ['뛰어갔으니 빼기를 해야 해요.', '5 - 2를 계산해 보세요.'],
      commonMistakes: [{ answer: '7', misconception: '더하기를 했어요. 떠났으니 빼야 합니다.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', 'subtraction', 'real_life', '1학년'],
  },
  {
    id: 'G1_S1_NUM_03_SK02_WP03',
    skillId: 'G1_S1_NUM_03_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: -1.5,
    difficultyLabel: '쉬움',
    content: {
      questionText: '동생이 사탕 2개를 가지고 있습니다. 형이 사탕 6개를 가지고 있습니다. 둘이 합하면 사탕은 모두 몇 개일까요?',
      correctAnswer: 8,
      explanation: '2 + 6 = 8개입니다.',
      hints: ['동생의 사탕 수와 형의 사탕 수를 더하세요.', '2 + 6을 계산해 보세요.'],
      commonMistakes: [{ answer: '4', misconception: '빼기를 했어요. 합하면이니 더해야 해요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', 'addition', 'real_life', '1학년'],
  },
  {
    id: 'G1_S1_NUM_03_SK02_WP04',
    skillId: 'G1_S1_NUM_03_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '접시에 과자가 9개 있었습니다. 민수가 4개를 먹었습니다. 접시에 남은 과자는 몇 개일까요?',
      correctAnswer: 5,
      explanation: '9개에서 4개를 먹었으므로 9 - 4 = 5개입니다.',
      hints: ['먹었으니 빼기를 해야 해요.', '9 - 4를 계산해 보세요.'],
      commonMistakes: [{ answer: '13', misconception: '더하기를 했어요. 먹었으니 빼야 합니다.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', 'subtraction', 'real_life', '1학년'],
  },
  {
    id: 'G1_S1_NUM_03_SK01_WP01',
    skillId: 'G1_S1_NUM_03_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: -2.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '강아지 3마리와 고양이 2마리가 놀고 있습니다. 동물은 모두 몇 마리일까요?',
      correctAnswer: 5,
      explanation: '강아지 3마리와 고양이 2마리를 모으면 3 + 2 = 5마리입니다.',
      hints: ['강아지 수와 고양이 수를 모으세요.', '3 + 2를 계산해 보세요.'],
      commonMistakes: [{ answer: '1', misconception: '빼기를 했어요. 모두 몇 마리인지 물었으니 더해야 해요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', 'addition', 'real_life', '1학년'],
  },
  ...
  // --- 50까지의 수 문장형 ---
  {
    id: 'G1_S1_NUM_04_SK02_WP01',
    skillId: 'G1_S1_NUM_04_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '우리 반에 학생이 23명 있습니다. 십의 자리 숫자는 무엇인가요?',
      correctAnswer: 2,
      explanation: '23에서 십의 자리 숫자는 2입니다. 10이 2개라는 뜻이에요.',
      hints: ['두 자리 수에서 왼쪽 숫자가 십의 자리예요.', '23 = 20 + 3이에요. 20에서 10이 몇 개?'],
      commonMistakes: [{ answer: '3', misconception: '일의 자리를 골랐어요. 왼쪽 숫자가 십의 자리입니다.' }],
    },
    estimatedTimeSeconds: 20,
    tags: ['word_problem', 'place_value', 'real_life', '1학년'],
  },
  {
    id: 'G1_S1_NUM_04_SK01_WP01',
    skillId: 'G1_S1_NUM_04_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: -1.5,
    difficultyLabel: '쉬움',
    content: {
      questionText: '체육 시간에 줄넘기를 10번씩 3묶음 했습니다. 줄넘기를 모두 몇 번 했을까요?',
      correctAnswer: 30,
      explanation: '10번씩 3묶음이면 10 + 10 + 10 = 30번입니다.',
      hints: ['10씩 세어 보세요. 10, 20, ...', '10이 3개이면?'],
      commonMistakes: [{ answer: '13', misconception: '10과 3을 더했어요. 10씩 3번이니 10 + 10 + 10이에요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', 'counting_tens', 'real_life', '1학년'],
  },

  // --- 덧셈과 뺄셈(2) 문장형 ---
  {
    id: 'G1_S1_NUM_05_SK01_WP01',
    skillId: 'G1_S1_NUM_05_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '문구점에서 연필 20자루와 지우개 5개를 샀습니다. 물건은 모두 몇 개일까요?',
      correctAnswer: 25,
      explanation: '20 + 5 = 25개입니다.',
      hints: ['연필 수와 지우개 수를 더하세요.', '20 + 5를 계산해 보세요.'],
      commonMistakes: [{ answer: '15', misconception: '빼기를 했어요. 모두 몇 개인지 물었으니 더해야 해요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', 'addition', 'real_life', '1학년'],
  },
  {
    id: 'G1_S1_NUM_05_SK02_WP01',
    skillId: 'G1_S1_NUM_05_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '책꽂이에 책이 38권 있었습니다. 동생이 5권을 꺼냈습니다. 남은 책은 몇 권일까요?',
      correctAnswer: 33,
      explanation: '38 - 5 = 33권입니다.',
      hints: ['꺼냈으니 빼기를 해야 해요.', '38 - 5를 계산해 보세요.'],
      commonMistakes: [{ answer: '43', misconception: '더하기를 했어요. 꺼냈으니 빼야 합니다.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', 'subtraction', 'real_life', '1학년'],
  },
  {
    id: 'G1_S1_NUM_05_SK01_WP02',
    skillId: 'G1_S1_NUM_05_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: -0.5,
    difficultyLabel: '보통',
    content: {
      questionText: '피자 가게에서 오전에 피자 21판을 팔았고, 오후에 16판을 팔았습니다. 하루에 판 피자는 모두 몇 판일까요?',
      correctAnswer: 37,
      explanation: '21 + 16 = 37판입니다. 일의 자리: 1 + 6 = 7, 십의 자리: 2 + 1 = 3.',
      hints: ['오전과 오후에 판 수를 더하세요.', '21 + 16을 계산해 보세요.'],
      commonMistakes: [{ answer: '5', misconception: '빼기를 했어요. 모두이니 더해야 해요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', 'addition', 'real_life', '1학년'],
  },
  ...
  // --- 100까지의 수 문장형 ---
  {
    id: 'G1_S2_NUM_01_SK01_WP01',
    skillId: 'G1_S2_NUM_01_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: -0.5,
    difficultyLabel: '보통',
    content: {
      questionText: '운동장에 학생이 10명씩 8줄로 서 있습니다. 학생은 모두 몇 명일까요?',
      correctAnswer: 80,
      explanation: '10명씩 8줄이면 10 + 10 + 10 + 10 + 10 + 10 + 10 + 10 = 80명입니다.',
      hints: ['10씩 8번 세어 보세요.', '10, 20, 30, 40, 50, 60, 70, ...'],
      commonMistakes: [{ answer: '18', misconception: '10과 8을 더했어요. 10씩 8묶음이에요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', 'counting_tens', 'real_life', '1학년'],
  },
  {
    id: 'G1_S2_NUM_01_SK02_WP01',
    skillId: 'G1_S2_NUM_01_SK02',
    questionType: 'MULTIPLE_CHOICE',
    difficulty: -0.5,
    difficultyLabel: '보통',
    content: {
      questionText: '아빠가 귤 67개를, 엄마가 귤 58개를 샀습니다. 누가 더 많이 샀을까요?',
      options: [
        { id: 'a', text: '아빠', isCorrect: true },
        { id: 'b', text: '엄마', isCorrect: false },
        { id: 'c', text: '같다', isCorrect: false },
        { id: 'd', text: '알 수 없다', isCorrect: false },
      ],
      explanation: '67 > 58이므로 아빠가 더 많이 샀습니다. 십의 자리를 비교하면 6 > 5입니다.',
      hints: ['두 수의 십의 자리를 먼저 비교하세요.', '6과 5 중 어느 쪽이 더 큰가요?'],
      commonMistakes: [{ answer: '엄마', misconception: '58의 일의 자리 8이 크다고 생각했어요. 십의 자리부터 비교해야 해요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', 'comparison', 'real_life', '1학년'],
  },

  // --- 받아올림/받아내림 문장형 ---
  {
    id: 'G1_S2_NUM_02_SK01_WP01',
    skillId: 'G1_S2_NUM_02_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: -0.5,
    difficultyLabel: '보통',
    content: {
      questionText: '토끼가 당근 8개를 먹었고, 또 7개를 더 먹었습니다. 토끼가 먹은 당근은 모두 몇 개일까요?',
      correctAnswer: 15,
      explanation: '8 + 7 = 15개입니다. 8 + 2 = 10, 10 + 5 = 15로 계산할 수 있어요.',
      hints: ['8에 7을 더해 보세요.', '8 + 2 = 10이고, 남은 5를 더하면?'],
      commonMistakes: [{ answer: '1', misconception: '빼기를 했어요. 더 먹었으니 더해야 합니다.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', 'addition', 'carry', 'real_life', '1학년'],
  },
  {
    id: 'G1_S2_NUM_02_SK02_WP01',
    skillId: 'G1_S2_NUM_02_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: -0.5,
    difficultyLabel: '보통',
    content: {
      questionText: '가게에 빵이 15개 있었습니다. 손님이 8개를 사 갔습니다. 남은 빵은 몇 개일까요?',
      correctAnswer: 7,
      explanation: '15 - 8 = 7개입니다.',
      hints: ['사 갔으니 빼기를 해야 해요.', '15 - 8을 계산해 보세요.'],
      commonMistakes: [{ answer: '23', misconception: '더하기를 했어요. 사 갔으니 빼야 합니다.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', 'subtraction', 'borrow', 'real_life', '1학년'],
  },
  {
    id: 'G1_S2_NUM_02_SK01_WP02',
    skillId: 'G1_S2_NUM_02_SK01',
    questionType: 'SHORT_ANSWER',
    difficulty: -0.5,
    difficultyLabel: '보통',
    content: {
      questionText: '수족관에 금붕어가 6마리 있고, 열대어가 9마리 있습니다. 물고기는 모두 몇 마리일까요?',
      correctAnswer: 15,
      explanation: '6 + 9 = 15마리입니다.',
      hints: ['금붕어 수와 열대어 수를 더하세요.', '6 + 9를 계산해 보세요.'],
      commonMistakes: [{ answer: '3', misconception: '빼기를 했어요. 모두이니 더해야 합니다.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', 'addition', 'carry', 'real_life', '1학년'],
  },
  {
    id: 'G1_S2_NUM_02_SK02_WP02',
    skillId: 'G1_S2_NUM_02_SK02',
    questionType: 'SHORT_ANSWER',
    difficulty: 0.0,
    difficultyLabel: '보통',
    content: {
      questionText: '어린이날에 풍선 14개를 받았습니다. 바람이 불어 6개가 날아갔습니다. 남은 풍선은 몇 개일까요?',
      correctAnswer: 8,
      explanation: '14 - 6 = 8개입니다.',
      hints: ['날아갔으니 빼기를 해야 해요.', '14 - 6을 계산해 보세요.'],
      commonMistakes: [{ answer: '20', misconception: '더하기를 했어요. 날아갔으니 빼야 합니다.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', 'subtraction', 'borrow', 'real_life', '1학년'],
  },
  ...
  // --- 세 수 계산 문장형 ---
  {
    id: 'G1_S2_NUM_02_SK03_WP01',
    skillId: 'G1_S2_NUM_02_SK03',
    questionType: 'SHORT_ANSWER',
    difficulty: 0.0,
    difficultyLabel: '보통',
    content: {
      questionText: '지우가 색종이 3장을 가지고 있었습니다. 아빠에게 2장을 받고, 엄마에게 4장을 더 받았습니다. 지우의 색종이는 모두 몇 장일까요?',
      correctAnswer: 9,
      explanation: '3 + 2 + 4 = 9장입니다. 먼저 3 + 2 = 5, 그 다음 5 + 4 = 9.',
      hints: ['처음 있던 것에 받은 것을 차례로 더하세요.', '3 + 2 = 5, 5 + 4 = ?'],
      commonMistakes: [{ answer: '6', misconception: '마지막 4장을 빼버렸어요. 받았으니 더해야 합니다.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['word_problem', 'three_numbers', 'addition', 'real_life', '1학년'],
  },
  {
    id: 'G1_S2_NUM_02_SK03_WP02',
    skillId: 'G1_S2_NUM_02_SK03',
    questionType: 'SHORT_ANSWER',
    difficulty: 0.0,
    difficultyLabel: '보통',
    content: {
      questionText: '케이크 위에 초가 8개 있었습니다. 바람에 2개가 꺼지고, 다시 1개를 켰습니다. 지금 켜져 있는 초는 몇 개일까요?',
      correctAnswer: 7,
      explanation: '8 - 2 + 1 = 7개입니다. 먼저 8 - 2 = 6, 그 다음 6 + 1 = 7.',
      hints: ['꺼진 것은 빼고, 켠 것은 더하세요.', '8 - 2 = 6, 6 + 1 = ?'],
      commonMistakes: [{ answer: '5', misconception: '1도 빼버렸어요. 다시 켰으니 더해야 해요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['word_problem', 'three_numbers', 'mixed_ops', 'real_life', '1학년'],
  },

  // --- 시계 문장형 ---
  {
    id: 'G1_S2_CHANGE_03_SK01_WP01',
    skillId: 'G1_S2_CHANGE_03_SK01',
    questionType: 'MULTIPLE_CHOICE',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '민준이는 아침 8시에 학교에 갑니다. 짧은 바늘이 8을, 긴 바늘이 12를 가리키는 시계를 골라야 합니다. 이것은 몇 시일까요?',
      options: [
        { id: 'a', text: '7시', isCorrect: false },
        { id: 'b', text: '8시', isCorrect: true },
        { id: 'c', text: '9시', isCorrect: false },
        { id: 'd', text: '12시', isCorrect: false },
      ],
      explanation: '짧은 바늘이 8을 가리키고 긴 바늘이 12를 가리키면 8시 정각입니다.',
      hints: ['짧은 바늘이 가리키는 숫자가 "시"예요.', '긴 바늘이 12를 가리키면 정각이에요.'],
      commonMistakes: [{ answer: '12시', misconception: '긴 바늘의 숫자를 읽었어요. 짧은 바늘이 "시"를 나타내요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['word_problem', 'clock', 'real_life', '1학년'],
  },

  // --- 모양 문장형 ---
  {
    id: 'G1_S1_SHAPE_02_SK01_WP01',
    skillId: 'G1_S1_SHAPE_02_SK01',
    questionType: 'MULTIPLE_CHOICE',
    difficulty: -2.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '수아는 생일 선물 상자를 보고 있습니다. 이 상자는 어떤 모양과 비슷할까요?',
      options: [
        { id: 'a', text: '공 모양', isCorrect: false },
        { id: 'b', text: '상자 모양(직육면체)', isCorrect: true },
        { id: 'c', text: '둥근기둥 모양', isCorrect: false },
        { id: 'd', text: '뿔 모양', isCorrect: false },
      ],
      explanation: '선물 상자는 네모난 면으로 이루어진 상자 모양(직육면체)입니다.',
      hints: ['상자는 평평한 면이 있나요, 둥근 면이 있나요?', '네모난 면이 여러 개인 모양을 찾아보세요.'],
      commonMistakes: [{ answer: '공 모양', misconception: '상자는 굴러가지 않아요. 평평한 면이 있는 모양이에요.' }],
    },
    estimatedTimeSeconds: 20,
    tags: ['word_problem', 'shapes', 'real_life', '1학년'],
  },
  ...
  // --- 9까지의 수 순서 ---
  {
    ...
    content: {
      ...
      correctOrder: ['2', '5', '7', '9'],
      explanation: '작은 수부터 크기 순서대로 나열하면 2, 5, 7, 9입니다.',
      hints: ['가장 작은 수를 먼저 찾으세요.', '수를 세면서 비교해 보세요.'],
      commonMistakes: [{ answer: '9,7,5,2', misconception: '큰 수부터 나열했어요. 작은 수부터 시작하세요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['ordering', 'number_sense', '1학년'],
  },
  {
    id: 'G1_S1_NUM_01_SK03_ORD02',
    skillId: 'G1_S1_NUM_01_SK03',
    questionType: 'ORDERING',
    difficulty: -2.0,
    difficultyLabel: '쉬움',
    content: {
      ...
      correctOrder: ['8', '6', '3', '1'],
      explanation: '큰 수부터 순서대로 나열하면 8, 6, 3, 1입니다.',
      hints: ['가장 큰 수를 먼저 찾으세요.', '8이 가장 크고, 1이 가장 작아요.'],
      commonMistakes: [{ answer: '1,3,6,8', misconception: '작은 수부터 나열했어요. 큰 수부터 시작하세요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['ordering', 'number_sense', '1학년'],
  },
  {
    id: 'G1_S1_NUM_01_SK03_ORD03',
    skillId: 'G1_S1_NUM_01_SK03',
    questionType: 'ORDERING',
    difficulty: -2.5,
    difficultyLabel: '매우 쉬움',
    content: {
      questionText: '다음 수를 작은 수부터 순서대로 놓으세요.',
      correctOrder: ['1', '3', '5'],
      explanation: '작은 수부터 나열하면 1, 3, 5입니다.',
      hints: ['가장 작은 수는 1이에요.', '1 다음으로 작은 수는?'],
      commonMistakes: [{ answer: '5,3,1', misconception: '큰 수부터 나열했어요. 작은 수부터 시작하세요.' }],
    },
    estimatedTimeSeconds: 20,
    tags: ['ordering', 'number_sense', '1학년'],
  },
  ...
  // --- 50까지의 수 순서 ---
  {
    ...
    content: {
      questionText: '다음 수를 작은 수부터 순서대로 놓으세요.',
      correctOrder: ['12', '25', '38', '47'],
      explanation: '작은 수부터 나열하면 12, 25, 38, 47입니다.',
      hints: ['십의 자리 수를 먼저 비교하세요.', '십의 자리가 1인 수가 가장 작아요.'],
      commonMistakes: [{ answer: '47,38,25,12', misconception: '큰 수부터 나열했어요. 작은 수부터 시작하세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['ordering', 'number_sense', '1학년'],
  },
  {
    id: 'G1_S1_NUM_04_SK03_ORD02',
    skillId: 'G1_S1_NUM_04_SK03',
    questionType: 'ORDERING',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '다음 수를 큰 수부터 순서대로 놓으세요.',
      correctOrder: ['50', '34', '21', '15'],
      explanation: '큰 수부터 나열하면 50, 34, 21, 15입니다.',
      hints: ['가장 큰 수를 먼저 찾으세요.', '50이 가장 크고, 15가 가장 작아요.'],
      commonMistakes: [{ answer: '15,21,34,50', misconception: '작은 수부터 나열했어요. 큰 수부터 시작하세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['ordering', 'number_sense', '1학년'],
  },
  ...
  // --- 100까지의 수 순서 ---
  {
    ...
    content: {
      questionText: '다음 수를 작은 수부터 순서대로 놓으세요.',
      correctOrder: ['54', '68', '79', '93'],
      explanation: '작은 수부터 나열하면 54, 68, 79, 93입니다.',
      hints: ['십의 자리 수를 비교하세요.', '5 < 6 < 7 < 9이므로 54가 가장 작아요.'],
      commonMistakes: [{ answer: '93,79,68,54', misconception: '큰 수부터 나열했어요. 작은 수부터 시작하세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['ordering', 'number_sense', '1학년'],
  },
  {
    id: 'G1_S2_NUM_01_SK02_ORD02',
    skillId: 'G1_S2_NUM_01_SK02',
    questionType: 'ORDERING',
    difficulty: -0.5,
    difficultyLabel: '보통',
    content: {
      questionText: '다음 수를 큰 수부터 순서대로 놓으세요.',
      correctOrder: ['100', '87', '63', '55'],
      explanation: '큰 수부터 나열하면 100, 87, 63, 55입니다.',
      hints: ['100이 가장 큰 수예요.', '나머지 수의 십의 자리를 비교하세요.'],
      commonMistakes: [{ answer: '55,63,87,100', misconception: '작은 수부터 나열했어요. 큰 수부터 시작하세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['ordering', 'number_sense', '1학년'],
  },
  ...
  // --- 규칙 찾기 순서 ---
  {
    id: 'G1_S2_CHANGE_03_SK02_ORD01',
    skillId: 'G1_S2_CHANGE_03_SK02',
    questionType: 'ORDERING',
    difficulty: -0.5,
    difficultyLabel: '보통',
    content: {
      questionText: '규칙에 맞게 순서대로 놓으세요: 2씩 커지는 수',
      correctOrder: ['2', '4', '6', '8', '10'],
      explanation: '2씩 커지는 규칙이므로 2, 4, 6, 8, 10 순서입니다.',
      hints: ['2 다음에 2를 더한 수는?', '2, 4, 6, ...'],
      commonMistakes: [{ answer: '10,8,6,4,2', misconception: '큰 수부터 나열했어요. 2씩 커지는 순서로 놓으세요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['ordering', 'pattern', '1학년'],
  },
  {
    id: 'G1_S2_CHANGE_03_SK02_ORD02',
    skillId: 'G1_S2_CHANGE_03_SK02',
    questionType: 'ORDERING',
    difficulty: 0.0,
    difficultyLabel: '보통',
    content: {
      questionText: '규칙에 맞게 순서대로 놓으세요: 5씩 커지는 수',
      correctOrder: ['5', '10', '15', '20', '25'],
      explanation: '5씩 커지는 규칙이므로 5, 10, 15, 20, 25 순서입니다.',
      hints: ['5 다음에 5를 더하면?', '5, 10, 15, ...'],
      commonMistakes: [{ answer: '25,20,15,10,5', misconception: '큰 수부터 나열했어요. 작은 수부터 시작하세요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['ordering', 'pattern', '1학년'],
  },
  {
    id: 'G1_S1_NUM_01_SK03_ORD04',
    skillId: 'G1_S1_NUM_01_SK03',
    questionType: 'ORDERING',
    difficulty: -2.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '다음 수를 작은 수부터 순서대로 놓으세요.',
      correctOrder: ['4', '6', '7', '9'],
      explanation: '작은 수부터 나열하면 4, 6, 7, 9입니다.',
      hints: ['가장 작은 수를 먼저 찾으세요.', '4가 가장 작아요.'],
      commonMistakes: [{ answer: '9,7,6,4', misconception: '큰 수부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 25,
    tags: ['ordering', 'number_sense', '1학년'],
  },
  ...
  // --- 9까지의 수 매칭 ---
  {
    id: 'G1_S1_NUM_01_SK01_MAT01',
    skillId: 'G1_S1_NUM_01_SK01',
    questionType: 'MATCHING',
    difficulty: -2.5,
    difficultyLabel: '매우 쉬움',
    content: {
      questionText: '수와 개수가 같은 것끼리 연결하세요.',
      pairs: [
        { left: '🍎🍎', right: '2' },
        { left: '🍎🍎🍎🍎🍎', right: '5' },
        { left: '🍎🍎🍎', right: '3' },
      ...
      explanation: '사과 2개 → 2, 사과 5개 → 5, 사과 3개 → 3, 사과 7개 → 7입니다.',
      hints: ['사과를 하나씩 세어 보세요.', '각각의 그림에서 사과가 몇 개인지 세어 수와 연결하세요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '세는 것을 빠뜨렸어요. 하나씩 짚어가며 세어 보세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['matching', 'counting', '1학년'],
  },
  {
    id: 'G1_S1_NUM_01_SK02_MAT01',
    skillId: 'G1_S1_NUM_01_SK02',
    questionType: 'MATCHING',
    difficulty: -2.0,
    difficultyLabel: '쉬움',
    content: {
      ...
      explanation: '1은 일, 4는 사, 7은 칠, 9는 구라고 읽습니다.',
      hints: ['수를 소리 내어 읽어 보세요.', '1은 "일"이라고 읽어요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '수의 이름을 다시 한 번 확인해 보세요.' }],
    },
    estimatedTimeSeconds: 25,
  ...
  // --- 덧셈과 뺄셈(1) 매칭 ---
  {
    ...
    content: {
      ...
      explanation: '3+4=7, 2+3=5, 6+2=8, 1+5=6입니다.',
      hints: ['각 덧셈을 먼저 계산하세요.', '3 + 4는 얼마인가요?'],
      commonMistakes: [{ answer: 'mixed', misconception: '계산을 다시 확인해 보세요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['matching', 'addition', '1학년'],
  },
  {
    id: 'G1_S1_NUM_03_SK02_MAT02',
    skillId: 'G1_S1_NUM_03_SK02',
    questionType: 'MATCHING',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '뺄셈과 그 답을 연결하세요.',
      pairs: [
        { left: '9 - 3', right: '6' },
        { left: '7 - 2', right: '5' },
        { left: '8 - 4', right: '4' },
      ...
      explanation: '9-3=6, 7-2=5, 8-4=4, 5-3=2입니다.',
      hints: ['각 뺄셈을 먼저 계산하세요.', '9 - 3은 얼마인가요?'],
      commonMistakes: [{ answer: 'mixed', misconception: '뺄셈 계산을 다시 해 보세요.' }],
    },
    estimatedTimeSeconds: 35,
    tags: ['matching', 'subtraction', '1학년'],
  },

  // --- 50까지의 수 매칭 ---
  {
    id: 'G1_S1_NUM_04_SK02_MAT01',
    skillId: 'G1_S1_NUM_04_SK02',
    questionType: 'MATCHING',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '수와 그 수의 십의 자리 숫자를 연결하세요.',
      pairs: [
        { left: '15', right: '1' },
        { left: '32', right: '3' },
        { left: '47', right: '4' },
      ...
      explanation: '15의 십의 자리는 1, 32의 십의 자리는 3, 47의 십의 자리는 4, 28의 십의 자리는 2입니다.',
      hints: ['두 자리 수에서 왼쪽 숫자가 십의 자리예요.', '15 = 10 + 5이므로 십의 자리는 1이에요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '일의 자리와 십의 자리를 헷갈렸어요. 왼쪽이 십의 자리입니다.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['matching', 'place_value', '1학년'],
  },

  // --- 모양 매칭 ---
  {
    id: 'G1_S1_SHAPE_02_SK01_MAT01',
    skillId: 'G1_S1_SHAPE_02_SK01',
    questionType: 'MATCHING',
    difficulty: -2.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '물건과 닮은 모양을 연결하세요.',
      pairs: [
        { left: '축구공', right: '공 모양' },
        { left: '선물 상자', right: '상자 모양' },
        { left: '음료수 캔', right: '둥근기둥 모양' },
        { left: '주사위', right: '상자 모양' },
      ],
      explanation: '축구공은 공 모양, 선물 상자와 주사위는 상자 모양, 음료수 캔은 둥근기둥 모양입니다.',
      hints: ['둥글게 굴러가는 것은 공 모양이에요.', '네모난 면이 있는 것은 상자 모양이에요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '각 물건의 생김새를 잘 떠올려 보세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['matching', 'shapes', '1학년'],
  },

  // --- 덧셈과 뺄셈(2) 매칭 ---
  {
    id: 'G1_S1_NUM_05_SK01_MAT01',
    skillId: 'G1_S1_NUM_05_SK01',
    questionType: 'MATCHING',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '덧셈과 그 답을 연결하세요.',
      pairs: [
        { left: '20 + 5', right: '25' },
        { left: '30 + 7', right: '37' },
        { left: '40 + 2', right: '42' },
      ...
      explanation: '20+5=25, 30+7=37, 40+2=42, 10+8=18입니다.',
      hints: ['몇십에 낱개를 더해 보세요.', '20 + 5 = ?'],
      commonMistakes: [{ answer: 'mixed', misconception: '십의 자리와 일의 자리를 합쳐 보세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['matching', 'addition', '1학년'],
  },
  ...
  // --- 시계 매칭 ---
  {
    id: 'G1_S2_CHANGE_03_SK01_MAT01',
    skillId: 'G1_S2_CHANGE_03_SK01',
    questionType: 'MATCHING',
    difficulty: -1.0,
    difficultyLabel: '쉬움',
    content: {
      questionText: '시각과 하는 일을 연결하세요.',
      pairs: [
        { left: '아침 8시', right: '학교 가기' },
        { left: '낮 12시', right: '점심 먹기' },
        { left: '오후 3시', right: '간식 먹기' },
        { left: '밤 9시', right: '잠자기' },
      ],
      explanation: '아침 8시에 학교, 12시에 점심, 오후 3시에 간식, 밤 9시에 잠을 잡니다.',
      hints: ['하루 일과를 떠올려 보세요.', '아침에는 학교에 가지요?'],
      commonMistakes: [{ answer: 'mixed', misconception: '하루 일과를 생각해 보세요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['matching', 'clock', 'real_life', '1학년'],
  },

  // --- 받아올림 매칭 ---
  {
    id: 'G1_S2_NUM_02_SK01_MAT01',
    skillId: 'G1_S2_NUM_02_SK01',
    questionType: 'MATCHING',
    difficulty: -0.5,
    difficultyLabel: '보통',
    content: {
      ...
      explanation: '7+6=13, 8+5=13, 9+4=13, 6+8=14입니다.',
      hints: ['각 덧셈을 계산해 보세요.', '받아올림에 주의하세요.'],
      commonMistakes: [{ answer: 'mixed', misconception: '받아올림을 잊지 말고 다시 계산해 보세요.' }],
    },
    estimatedTimeSeconds: 35,
