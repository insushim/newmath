...
export const G5_QUESTIONS: SeedQuestion[] = [
  ...
  },
  {
    ...
    difficultyLabel: '보통',
    content: {
      questionText: '수학 시험에서 민수, 지영, 서준, 하은이의 점수가 각각 85점, 90점, 75점, 90점입니다. 네 사람의 평균 점수는 몇 점인가요?',
      correctAnswer: '85',
      explanation: '(85 + 90 + 75 + 90) ÷ 4 = 340 ÷ 4 = 85점입니다.',
      hints: ['네 사람의 점수를 모두 더하세요.', '합계를 사람 수로 나누세요. 340 ÷ 4 = ?'],
      commonMistakes: [{ answer: '90', misconception: '가장 많이 나온 점수를 평균으로 착각했어요.' }],
    },
    estimatedTimeSeconds: 30,
    tags: ['word_problem', '평균', '통계', '5학년'],
  },
  {
  ...
  },
  {
    ...
    difficultyLabel: '매우 어려움',
    content: {
      questionText: '축구 동아리 5명의 골 수가 2, 4, 3, 1, 5입니다. 평균이 4골이 되려면 다음 경기에서 몇 골을 넣어야 하나요? (6명이 됩니다)',
      correctAnswer: '9',
      explanation: '6명 평균 4골 → 총 골 수 = 4 × 6 = 24골. 현재 합 = 2+4+3+1+5 = 15골. 필요한 골 = 24 - 15 = 9골.',
      hints: ['목표 총 골 수 = 평균 × 인원수', '24 - 15 = ?'],
      commonMistakes: [{ answer: '5', misconception: '현재 평균 3골에서 4골이 되려면 1골 더... 가 아니라 총합으로 계산해야 해요.' }],
    },
    estimatedTimeSeconds: 45,
    tags: ['word_problem', '평균', '통계', '스포츠', '5학년'],
  },
  {
  ...
  },
  {
    ...
    difficultyLabel: '보통',
    content: {
      questionText: '다음 학생들의 평균 점수를 높은 것부터 순서대로 놓으세요.',
      correctOrder: ['민수 (90, 80) → 85점', '지영 (70, 90) → 80점', '서준 (60, 80) → 70점', '하은 (50, 70) → 60점'],
      explanation: '각각의 평균: 민수 85, 지영 80, 서준 70, 하은 60점입니다.',
      hints: ['각 학생의 두 점수를 더해서 2로 나누세요.', '(90+80)÷2 = 85'],
      commonMistakes: [{ answer: '하은,서준,지영,민수', misconception: '낮은 것부터 나열했어요.' }],
    },
    estimatedTimeSeconds: 40,
    tags: ['ordering', '평균', '통계', '5학년'],
  },
  {
