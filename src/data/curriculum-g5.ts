...
export const G5_SKILLS: SeedSkill[] = [
  ...
  {
    id: 'G5_S1_NUM_01_SK05',
    unitId: 'G5_S1_NUM_01',
    code: 'mixed_calc_order_drill',
    nameKo: '계산 순서 연습',
    descriptionKo: '다양한 혼합 계산식에서 계산 순서를 확인하고 연습한다.',
    defaultDifficulty: 0.4,
    sortOrder: 2,
    conceptExplanation: '곱셈·나눗셈을 먼저, 덧셈·뺄셈은 나중에! 여러 문제를 반복해서 순서가 자동으로 떠오르게 연습해요.',
  },
  {
  ...
  {
    id: 'G5_S1_NUM_01_SK06',
    unitId: 'G5_S1_NUM_01',
    code: 'mixed_calc_bracket_drill',
    nameKo: '괄호 식 연습',
    descriptionKo: '다양한 괄호가 포함된 식을 반복 연습한다.',
    defaultDifficulty: 0.6,
    sortOrder: 4,
    conceptExplanation: '괄호 안을 먼저 계산하는 연습을 반복하면 복잡한 식도 자신있게 풀 수 있어요!',
  },
  {
  ...
  {
    id: 'G5_S1_NUM_01_SK07',
    unitId: 'G5_S1_NUM_01',
    code: 'mixed_calc_challenge',
    nameKo: '혼합 계산 도전',
    descriptionKo: '여러 단계의 복잡한 혼합 계산 문제를 풀 수 있다.',
    defaultDifficulty: 0.8,
    sortOrder: 6,
    conceptExplanation: '3단계 이상의 복잡한 식도 차근차근 순서대로 풀면 돼요. 한 단계씩 계산 결과를 적어가며 풀어보세요!',
  },
  {
  ...
  },
  {
    ...
    defaultDifficulty: 0.4,
    sortOrder: 2,
    conceptExplanation: '약수를 구할 때는 1부터 차례로 나누어봐요. 1 × 12, 2 × 6, 3 × 4이면 12의 약수는 1, 2, 3, 4, 6, 12예요.',
  },
  {
    id: 'G5_S1_NUM_02_SK06',
    unitId: 'G5_S1_NUM_02',
    code: 'divisor_drill',
    nameKo: '약수 연습',
    descriptionKo: '여러 수의 약수를 반복 연습하여 빠르게 구할 수 있다.',
    defaultDifficulty: 0.5,
    sortOrder: 3,
    conceptExplanation: '약수를 빨리 찾으려면 곱셈 짝을 이용하세요. 24 = 1×24, 2×12, 3×8, 4×6이므로 약수는 1,2,3,4,6,8,12,24!',
  },
  {
    ...
    defaultDifficulty: 0.4,
    sortOrder: 4,
    conceptExplanation: '3의 배수: 3, 6, 9, 12, ... 2의 배수: 끝자리가 짝수. 5의 배수: 끝자리가 0 또는 5.',
  },
  {
    id: 'G5_S1_NUM_02_SK07',
    unitId: 'G5_S1_NUM_02',
    code: 'multiple_drill',
    nameKo: '배수 연습',
    descriptionKo: '배수 판별법을 활용하여 다양한 배수 문제를 풀 수 있다.',
    defaultDifficulty: 0.5,
    sortOrder: 5,
    conceptExplanation: '배수 판별: 3의 배수는 각 자릿수의 합이 3의 배수. 9의 배수는 각 자릿수의 합이 9의 배수예요.',
  },
  {
    ...
    defaultDifficulty: 0.7,
    sortOrder: 6,
    conceptExplanation: '공약수: 두 수의 공통 약수. 최대공약수: 가장 큰 공약수. 공배수: 두 수의 공통 배수. 최소공배수: 가장 작은 공배수.',
  },
  {
    id: 'G5_S1_NUM_02_SK08',
    unitId: 'G5_S1_NUM_02',
    code: 'gcf_lcm_drill',
    nameKo: '최대공약수·최소공배수 연습',
    descriptionKo: '최대공약수와 최소공배수를 빠르게 구하는 연습을 한다.',
    defaultDifficulty: 0.7,
    sortOrder: 7,
    conceptExplanation: '최대공약수: 공통 약수 중 가장 큰 것. 최소공배수: 두 수의 곱 ÷ 최대공약수로도 구할 수 있어요!',
  },
  {
    ...
    defaultDifficulty: 0.8,
    sortOrder: 8,
    conceptExplanation: '최대공약수: 똑같이 나눠줄 때. 최소공배수: 동시에 만날 때. 실생활에서 많이 사용돼요!',
  },
  // ── 규칙과 대응 (7 skills) ─────────────────────
  {
    ...
    defaultDifficulty: 0.3,
    sortOrder: 1,
    conceptExplanation: '수가 어떻게 변하는지 살펴봐요. 2, 4, 6, 8은 2씩 커지는 규칙!',
  },
  {
    id: 'G5_S1_CHANGE_03_SK05',
    unitId: 'G5_S1_CHANGE_03',
    code: 'pattern_drill',
    nameKo: '규칙 찾기 연습',
    descriptionKo: '다양한 수열과 도형 배열에서 규칙을 찾는 연습을 한다.',
    defaultDifficulty: 0.4,
    sortOrder: 2,
    conceptExplanation: '덧셈 규칙, 곱셈 규칙, 제곱 규칙 등 여러 규칙 유형을 연습해요.',
  },
  {
    ...
    defaultDifficulty: 0.5,
    sortOrder: 3,
    conceptExplanation: '사탕을 3개씩 주면 사람 수 × 3 = 사탕 수. □ × 3 = △처럼 식으로 나타내요.',
  },
  {
    id: 'G5_S1_CHANGE_03_SK06',
    unitId: 'G5_S1_CHANGE_03',
    code: 'correspondence_drill',
    nameKo: '대응 관계 연습',
    descriptionKo: '표와 그림에서 대응 관계를 찾는 연습을 한다.',
    defaultDifficulty: 0.5,
    sortOrder: 4,
    conceptExplanation: '표에서 두 양이 어떻게 변하는지 비교해서 관계를 파악하는 연습이에요.',
  },
  {
    ...
    nameKo: '규칙을 식으로',
    descriptionKo: '대응 관계를 식으로 나타낼 수 있다.',
    defaultDifficulty: 0.6,
    sortOrder: 5,
    conceptExplanation: '□가 1,2,3일 때 △가 3,6,9이면 → △ = □ × 3이에요.',
  },
  {
    id: 'G5_S1_CHANGE_03_SK07',
    unitId: 'G5_S1_CHANGE_03',
    code: 'pattern_expression_drill',
    nameKo: '식으로 나타내기 연습',
    descriptionKo: '다양한 대응 관계를 식으로 나타내는 연습을 한다.',
    defaultDifficulty: 0.7,
    sortOrder: 6,
    conceptExplanation: '곱하기, 더하기, 빼기가 섞인 복잡한 대응 관계도 식으로 나타내 보세요.',
  },
  {
    ...
    defaultDifficulty: 0.8,
    sortOrder: 7,
    conceptExplanation: '규칙을 찾아 식을 세우면 모르는 값도 구할 수 있어요!',
  },
  // ── 합동과 대칭 (7 skills) ─────────────────────
  {
  ...
  },
  {
    ...
    defaultDifficulty: 0.5,
    sortOrder: 2,
    conceptExplanation: '대응변의 길이는 같고, 대응각의 크기도 같아요.',
  },
  {
    id: 'G5_S1_SHAPE_04_SK05',
    unitId: 'G5_S1_SHAPE_04',
    code: 'congruence_drill',
    nameKo: '합동 연습',
    descriptionKo: '합동인 도형을 찾고 대응 요소를 구하는 연습을 한다.',
    defaultDifficulty: 0.5,
    sortOrder: 3,
    conceptExplanation: '여러 도형 중에서 합동인 것을 찾고, 대응변과 대응각을 정확히 짝지어 보세요.',
  },
  {
    ...
    defaultDifficulty: 0.5,
    sortOrder: 4,
    conceptExplanation: '접으면 양쪽이 겹치는 도형이 선대칭. 그 직선이 대칭축!',
  },
  {
    id: 'G5_S1_SHAPE_04_SK06',
    unitId: 'G5_S1_SHAPE_04',
    code: 'line_symmetry_drill',
    nameKo: '선대칭 연습',
    descriptionKo: '선대칭 도형과 대칭축을 찾는 연습을 한다.',
    defaultDifficulty: 0.6,
    sortOrder: 5,
    conceptExplanation: '정삼각형은 대칭축 3개, 정사각형은 4개, 원은 무한개예요! 다양한 도형에서 대칭축을 찾아보세요.',
  },
  {
    ...
    defaultDifficulty: 0.6,
    sortOrder: 6,
    conceptExplanation: '180° 돌려서 겹치면 점대칭! 평행사변형은 점대칭 도형이에요.',
  },
  {
    id: 'G5_S1_SHAPE_04_SK07',
    unitId: 'G5_S1_SHAPE_04',
    code: 'symmetry_mixed',
    nameKo: '대칭 종합',
    descriptionKo: '선대칭과 점대칭을 종합적으로 판단하고 활용할 수 있다.',
    defaultDifficulty: 0.7,
    sortOrder: 7,
    conceptExplanation: '어떤 도형은 선대칭이면서 점대칭이기도 해요. 정사각형, 원 등이 그래요. 두 가지를 구분하고 활용해 보세요!',
  },
  // ── 자료의 표현 (7 skills) ─────────────────────
  {
    ...
    sortOrder: 1,
    conceptExplanation: '자료를 크기 순서대로 나열하고 같은 종류끼리 모아 표로 만들어요.',
  },
  {
    ...
    defaultDifficulty: 0.3,
    sortOrder: 2,
    conceptExplanation: '십의 자리가 줄기, 일의 자리가 잎. 예: 23, 25, 31이면 줄기 2에 잎 3, 5를 씁니다.',
  },
  {
    id: 'G5_S1_DATA_05_SK05',
    unitId: 'G5_S1_DATA_05',
    code: 'stem_leaf_make_drill',
    nameKo: '줄기와 잎 그림 만들기 연습',
    descriptionKo: '주어진 자료를 줄기와 잎 그림으로 나타내는 연습을 한다.',
    defaultDifficulty: 0.4,
    sortOrder: 3,
    conceptExplanation: '자료를 보고 직접 줄기와 잎 그림을 만들어 보세요. 잎은 항상 작은 수부터 크기 순서대로!',
  },
  {
    ...
    defaultDifficulty: 0.5,
    sortOrder: 4,
    conceptExplanation: '가장 큰 수, 가장 작은 수, 자료의 수, 가장 많이 나온 줄기를 읽을 수 있어요.',
  },
  {
    id: 'G5_S1_DATA_05_SK06',
    unitId: 'G5_S1_DATA_05',
    code: 'stem_leaf_read_drill',
    nameKo: '줄기와 잎 해석 연습',
    descriptionKo: '줄기와 잎 그림을 읽고 다양한 질문에 답하는 연습을 한다.',
    defaultDifficulty: 0.6,
    sortOrder: 5,
    conceptExplanation: '잎의 개수를 세면 전체 자료의 수를 알 수 있어요. 줄기별 잎 개수를 비교하면 분포를 파악할 수 있어요.',
  },
  {
    id: 'G5_S1_DATA_05_SK07',
    unitId: 'G5_S1_DATA_05',
    code: 'data_compare',
    nameKo: '자료 비교하기',
    descriptionKo: '두 자료를 줄기와 잎 그림으로 비교할 수 있다.',
    defaultDifficulty: 0.6,
    sortOrder: 6,
    conceptExplanation: '두 반의 성적을 줄기와 잎 그림으로 나란히 놓으면 어느 반이 더 잘했는지 비교할 수 있어요.',
  },
  {
    ...
    code: 'data_apply',
    nameKo: '자료 표현 활용',
    descriptionKo: '자료를 그림으로 나타내고 문제를 해결할 수 있다.',
    defaultDifficulty: 0.7,
    sortOrder: 7,
    conceptExplanation: '실생활 자료를 줄기와 잎 그림으로 정리하고 분석하는 종합 문제예요.',
  },
  // --- 수의 범위와 어림 ---
  {
